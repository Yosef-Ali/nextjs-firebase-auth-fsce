...
const programContent: Record<string, Program[]> = {
      ...
      content: [
        {
          ...
          children: [
            {
              _type: "span",
              text: "The Legal Support and Advocacy program works to ensure that children are protected through legal means. We provide direct legal representation and work to improve the legal framework for child protection."
            }
          ]
        }
      ],
